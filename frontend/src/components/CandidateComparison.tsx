  ...
  return (
    <div className="bg-goa-cream text-goa-dark border-2 border-goa-dark shadow-brutal p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b-2 border-goa-dark pb-4 mb-6">
        ...
        <div className="mt-2 sm:mt-0 flex flex-wrap items-center gap-2">
          ...
          {rtype === 'SOCIAL_MEDIA_POST' && (
            <div className="flex items-center space-x-1.5 px-3 py-1 bg-goa-pink text-goa-cream font-mono text-xs font-bold border border-goa-dark">
              <Share2 className="w-3.5 h-3.5" />
              <span>VERIFIED SOCIAL MEDIA POST</span>
            </div>
          )}
          {rtype === 'SOCIAL_MEDIA_PROFILE' && (
            <div className="flex items-center space-x-1.5 px-3 py-1 bg-goa-green text-goa-cream font-mono text-xs font-bold border border-goa-dark">
              <UserCheck className="w-3.5 h-3.5" />
              <span>SOCIAL MEDIA PROFILE</span>
            </div>
          )}
          {rtype === 'GENERAL_WEB_RESULT' && (
            <div className="flex items-center space-x-1.5 px-3 py-1 bg-goa-yellow/20 border border-goa-yellow/60 text-goa-green font-mono text-xs font-bold">
              <ShieldCheck className="w-4 h-4 text-goa-green" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch mb-6">
        ...
        {/* Left: Input Face */}
        <div className="bg-white border-2 border-goa-dark p-4 flex flex-col justify-between shadow-brutal text-goa-dark">
          <div className="flex items-center justify-between border-b border-goa-dark/15 pb-2 mb-3">
            <span className="text-xs font-mono font-bold text-goa-green uppercase">
              [A] INPUT SUBJECT ARTIFACT
            </span>
            <span className="text-[10px] font-mono text-[#666666] font-bold">LOCAL FILE</span>
          </div>

          <div className="bg-goa-dark p-2 border border-goa-dark mb-3 flex items-center justify-center min-h-[220px]">
            <img
          ...
          <div className="text-[11px] font-mono text-[#555555] truncate">
            SHA-256: <strong className="text-goa-dark font-bold">{inputSha256.slice(0, 16)}...</strong>
          </div>
        </div>
        ...
        <div className="bg-white border-2 border-goa-dark p-4 flex flex-col justify-between shadow-brutal text-goa-dark">
          <div className="flex items-center justify-between border-b border-goa-dark/15 pb-2 mb-3">
            <span className="text-xs font-mono font-bold text-goa-pink uppercase flex items-center gap-1.5">
              <Globe className="w-3.5 h-3.5" />
              [B] DISCOVERED {platform ? platform.toUpperCase() : 'WEB'} MATCH
            </span>
            <span className="text-[10px] font-mono bg-goa-pink text-goa-cream px-2 py-0.5 font-bold uppercase">
              {rtype.replace(/_/g, ' ')}
            </span>
          </div>
          ...
          <div className="bg-goa-dark p-2 border border-goa-dark mb-3 flex items-center justify-center min-h-[220px]">
            {candidateThumb ? (
              ...
              <div className="text-goa-cream font-mono text-xs">Thumbnail Rendered</div>
            )}
          </div>
          ...
          <div className="text-[11px] font-mono flex items-center justify-between">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-goa-pink font-bold hover:underline flex items-center gap-1"
            >
              <span>SOURCE ↗</span>
            </a>
          </div>
